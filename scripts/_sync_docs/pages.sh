# Confluence ↔ docs/ 동기화 대상 페이지 목록.
# pull_docs.sh / push_docs.sh 가 source 해서 공유한다.
#
# 형식: page_id|URL slug|출력 파일명|표시 라벨
...
PAGES=(
  ...
  "48332818|Implementation+Plan|implementation-plan|Implementation Plan"
